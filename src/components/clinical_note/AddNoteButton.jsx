...
export default function AddNoteButton({ onClick, label = 'Add Note', style = {}, className = '', iconColor = 'var(--color-surface)' }) {
  return (
    <button
    ...
    >
      <IconPlus size={18} color={iconColor} style={{ color: iconColor }} />
      <span>{label}</span>
    </button>
  );
}
